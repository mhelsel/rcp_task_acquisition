...
ONE_BACK_DISPLAY = {"instruction": "previous letter", "name": "1-back"}
TWO_BACK_DISPLAY = {"instruction": "letter shown 2 letters ago", "name": "2-back"}
...
SAME_BEGIN = (
    "You will now begin the @ task which will last about 3 minutes.\n"
