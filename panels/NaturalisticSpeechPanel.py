...
class NaturalisticSpeechPanel(TrialPanel):
    ...
    def _set_up_photo(self):
        ...
        self.adult_image_path = os.path.join(imdir, adult_img)
        ...
        self.child_image_path = os.path.join(imdir, child_img)
        ...
        self.adult_button = wx.RadioButton(self, label="Resort", name=adult_img,  size=(150, -1))
        # self.child_button.Bind(wx.EVT_RADIOBUTTON, self.continue_event)

        self.child_button = wx.RadioButton(self, label="Park", name=child_img, size=(150, -1))
